...
if (isset($_GET['total'])&&($_GET['total'] > 0) && (!empty($_SESSION['cart'])))
{
    ...
    $q = "SELECT * FROM products WHERE product_id IN (";
      ...
      {
        $query = "INSTERT INTO order_contents (order_id, product_id, quantity, price) 
        VALUES($order_id,".$row['product_id'].",".$_SESSION['cart'][$row['product_id']]['quantity'].","
      ...
      mysqli_close($link);
      echo "<p> Thanks for your order. Yuor order number is #".$order_id."</p>";
      $_SESSION['cart'] = NULL;
}
