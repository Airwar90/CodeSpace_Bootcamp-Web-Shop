...
<body>
    ...
    if ( isset( $errors ) && !empty( $errors ) )
    {
      ...
      echo 'Please try again or <a href="registration-form.php">Register</a></h4>
		  </div>';
    }
    ?>
          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <div class="form-outline form-white mb-4">              
                <input type="email" name = "user_email" id="typeEmailX" class="form-control form-control-lg" />
                <label class="form-label" for="typeEmailX">Email</label>
              </div>

              <div class="form-outline form-white mb-4">
                <input type="password" name="user_password" id="typePasswordX" class="form-control form-control-lg" />
            ...
            <div>
              <p class="mb-0">Don't have an account? <a href="registration-form.php" class="text-white-50 fw-bold">Sign Up</a>
              </p>
            </div>
